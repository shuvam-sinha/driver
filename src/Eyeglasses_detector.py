...
if type_of_eyes.lower()=='n':
    ...
    eye_detector = cv2.CascadeClassifier("/home/ssinha/Bluestamp_Project/haarcascade_eye_tree_eyeglasses.xml")
...
while time.monotonic() - start_time < 45:
    ...
    if type_of_eyes.lower() == 'y':
        eyes = eye_detector.detectMultiScale(grey, 1.1, 3)
    else:
